...
if __name__ == "__main__":
    ...
    destination_file = "test1.jpg"
    source_file = PROJECT_ROOT / "output/hak180产品安全手册/images/048c005b198be5c9fff80ad6a6ba02496f38fa109ec20dbaabde3110f3eb1574.jpg"
    resp = client.fput_object(bucket_name=bucket_name,object_name=destination_file,file_path=source_file)
    print(
